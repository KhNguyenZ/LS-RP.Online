...
new iItem_info[][Inv_Item] = {
	...
	{2, 1.0,"mdl-2004:item_9mm","Tec-9", "Sung tieu lien nho, su dung dan SMG, su dung vu khi va sau do su dung hop dan.", 1},
	{3, 1.1,"mdl-2004:item_9mm","Uzi", "Sung tieu lien nho, su dung dan SMG, su dung vu khi va sau do su dung hop dan.", 1},
	{4, 2.0,"mdl-2004:item_9mm","MP5", "Sung tieu lien, su dung dan SMG, su dung vu khi va sau do su dung hop dan.", 1},
	{5, 4.0,"mdl-2004:item_ak47","AK-47", "Sung truong tu dong, su dung dan Rifle, su dung vu khi va sau do su dung hop dan.", 1},
	{6, 3.5,"mdl-2004:item_ak47","M4A1", "Sung truong, su dung dan Rifle, su dung vu khi va sau do su dung hop dan.", 1},
	{7, 3.5,"mdl-2004:item_spas","Shotgun", "Shotgun, su dung dan Shotgun, su dung vu khi va sau do su dung hop dan.", 1},
	{7, 3.5,"mdl-2004:item_spas","Spas-12", "Shotgun ban tu dong, su dung dan Shotgun, su dung vu khi va sau do su dung hop dan.", 1},
	{8, 3.0,"mdl-2004:item_spas","Rifle", "Sung truong ban tu dong, su dung dan Rifle, su dung vu khi va sau do su dung hop dan.", 1},
	{9, 4.0,"mdl-2004:item_spas","Sniper", "Sung ban tia, su dung dan Sniper, su dung vu khi va sau do su dung hop dan.", 1}
};