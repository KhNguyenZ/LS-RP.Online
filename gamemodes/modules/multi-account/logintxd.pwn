...
hook OnPlayerConnect(playerid){
	...
	LoginPTD[playerid][4] = CreatePlayerTextDraw(playerid, 260.000, 121.000, "LS-RP");
	...
	LoginPTD[playerid][5] = CreatePlayerTextDraw(playerid, 305.000, 152.000, "ONLINE");
	...
	PlayerTextDrawSetSelectable(playerid, LoginPTD[playerid][7], 1);
...
func:ShowLoginPTD(playerid)
{
	...
	{
		PlayerTextDrawShow(playerid,LoginPTD[playerid][7]);
	}
...
func:HideLoginPTD(playerid)
{
	...
	for(new login_loop = 0 ; login_loop < sizeof(LoginPTD); login_loop++)
	{
		PlayerTextDrawHide(playerid,LoginPTD[playerid][7]);
	}
